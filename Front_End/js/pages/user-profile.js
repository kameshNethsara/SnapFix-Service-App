...
//     // Retrieve stored password (must already be encrypted)
//     const storedPassword = localStorage.getItem("password");

//     const role = localStorage.getItem("role");
//     const userWhenCreated = localStorage.getItem("userWhenCreated");
//     const userImgURL = $('#profilePicture').data('url') || "";
//     const userFullName = $('#editFullName').val();
//     const userEmail = $('#editEmail').val();
//     const userMobile = $('#editMobile').val();
//     const userInfo = $('#editUserInfo').val();
//     const street = $('#editStreet').val();
//     const city = $('#editCity').val();
//     const postalCode = $('#editPostalCode').val();
//     const userDepartment = $('#editDepartment').val();
...
//         userName: username,
//         userRole: role,
//         userPassword: newPassword, // plain here for backend
//         userWhenCreated,
//         userImgURL,
//         userFullName,
//         userEmail,
...
//     console.log("Updating password with data:", JSON.stringify(updatedUser));
...
//         // Store encrypted version for next time
